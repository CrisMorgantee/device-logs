      ...
      <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
        <div class="min-h-screen bg-gray-50">
          <div class="rounded-md bg-white p-4">
            ...
            <div
              class="text-md grid grid-cols-12 rounded-md bg-gradient-to-tr from-indigo-600 to-purple-600 py-2 px-4 font-bold text-white">
            ...
            <div>
              @foreach ($logs as $deviceLog)
                <div class="mt-4 grid grid-cols-12 gap-4 border-t px-4 text-sm font-normal first:border-none">
                  <div class="col-span-1">
                  ...
                  @dd(new Carbon($deviceLog->end_session_at)->format())
                  <div class="col-span-2">
